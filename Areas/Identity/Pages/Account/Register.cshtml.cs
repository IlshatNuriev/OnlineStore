...
namespace OnlineStore.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IEmailSender emailSender, RoleManager<IdentityRole> roleManager/*, IUserPhoneNumberStore<IdentityUser> userPhoneNumberStore*/)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, PhoneNumber = Input.PhoneNumber, FullName = Input.FullName }; //CreateUser();
